...
void main() {
  group('DartCreateClassCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late DartCreateClassCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = DartCreateClassCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = DartCreateClassCommandRunner();
